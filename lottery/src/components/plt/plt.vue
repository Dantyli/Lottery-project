...
export default{
    ...
    created(){
        this.$root.eventHub.$on('pltClear',this.clear)
        this.$root.eventHub.$on('pltBuy',this.sure)
    ...
    destroyed(){
        this.$root.eventHub.$off('pltClear');
        this.$root.eventHub.$off('pltBuy');
    }
}
</script>
<style>
